...
class ViewStyler implements Styler {
    ...
    private IFWidgetTreeFactory ifWidgetTreeFactory;
    protected Context context;

    ViewStyler(IFWidgetTreeFactory ifWidgetTreeFactory, Context context) {
        this.ifWidgetTreeFactory = ifWidgetTreeFactory;
        ...
        if(attributes.has("conditions")) {
            ...
            for(int i = 0; i < conditions.length(); i++) {
                ...
                if(value.equalsIgnoreCase(condition.getString("value"))) {
                    conditionView = ifWidgetTreeFactory.styleView(view, condition.getJSONObject("attributes"));
                }
            }
